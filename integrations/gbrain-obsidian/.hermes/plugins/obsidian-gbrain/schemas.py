OBSIDIAN_INGEST = {
    ...
    "description": (
        "Store durable user-provided knowledge into the local Obsidian vault "
        "through the deterministic ingestion pipeline. Use for explicit save, "
        "capture, inbox, vault, meeting note, project note, decision, or durable "
        "memory requests. This is the preferred Obsidian write path."
    ),
    "parameters": {
        "type": "object",
        "properties": {
